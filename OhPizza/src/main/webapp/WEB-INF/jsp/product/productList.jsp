											...
											<div class="card h-100">
												...
												<div class="card-body p-4">
													<div class="text-center">
														<!-- Product name-->
														<h5 class="fw-bolder">
															<a href="productInfo.do?prodNo=${product.prodNo }">${product.prodName}</a>
														</h5>
														<!-- Product reviews-->
														<div
													...
													<div class="text-center">
														...
														<form action="addOrder.do">
															...
															M ${product.priceM } <input type=radio name=price
																value='${product.priceL }'> L ${product.priceL }
															<p></p>
															<button class="btn btn-outline-dark flex-shrink-0" onclick="alert('로그인이 필요합니다.');" type="button"><i class="bi-cart-fill me-1"></i> Add to cart</button>
														</form>
													</div>
												</div>
												<!-- Product actions-->
